...
and exercised by `run_tests.py` (169 tests, all passing).
...
experiments/    thirty reproducible scripts; results/ holds their generated reports
tests/          169 tests; run_tests.py needs no pytest
```
