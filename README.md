...
and exercised by `run_tests.py` (123 tests, all passing).
...
experiments/    twenty-one reproducible scripts; results/ holds their generated reports
tests/          123 tests; run_tests.py needs no pytest
```
