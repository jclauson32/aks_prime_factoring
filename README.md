...
and exercised by `run_tests.py` (118 tests, all passing).
...
experiments/    twenty reproducible scripts; results/ holds their generated reports
tests/          118 tests; run_tests.py needs no pytest
```
